...
@section('content')
    <form action="{{ route('dashboard.update', ['id' => $school->id, 'name' => $school->name]) }}" method="POST"
        class="row mt-4 d-flex" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="col-lg-7">
            <div class="row">
                ...
                <div class="col-lg-8 d-flex flex-column">
                    <div class="d-flex flex-column">
                        ...
                        <input name="name" class="custom-form-control-1" type="text"
                    ...
                    <div class="d-flex flex-column mt-3">
                        ...
                        <input name="founded_year" id="founded_year" class="custom-form-control-1" type="text"
                ...
                <div class="col-md-6 d-flex flex-column mt-3">
                    ...
                    <input name="authority_name" id="authority_name" class="custom-form-control-1" type="text"
                        value="{{ old('authority_name') ?? optional($school->users()->first())->name }}">
                ...
                <div class="col-md-6 d-flex flex-column mt-3">
                    ...
                    <input name="position" id="authority_role" class="custom-form-control-1" type="text"
                        value="{{ old('position') ?? $school->users()->first()->position }}">
                    @error('position')
                        <span role="alert">
                            <strong class="text-danger">{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-12 d-flex flex-column mt-3">
                    ...
                    <input name="email" id="email" class="custom-form-control-1" type="text"
                        value="{{ old('email') ?? $school->users()->first()->email }}">
                    @error('email')
                        <span role="alert">
                            <strong class="text-danger">{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-6 d-flex flex-column mt-3">
                    ...
                    <input name="student_amount" id="student_amount" class="custom-form-control-1" type="text"
                        value="{{ old('student_amount') ?? $school->student_amount }}">
