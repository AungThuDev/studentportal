    ...
    <div class="col-lg-10 offset-lg-1 authority-form-container">
        <div class="row d-flex">
            ...
            <form action="" method="" class="col-md-7 offset-md-2 d-flex flex-column align-items-end">
                ...
                <div class="custom-form-control-2 rounded w-100 d-flex flex-wrap align-items-center justify-content-around">
                    <p class="mb-0">Authority Name -</p>
                    <input id="authority-name" class="authority-input fw-bold text-dark" value="Ms. Thiri Shwe Sin" disabled>
                </div>
        ...
        <div class="row d-flex justify-content-between flex-wrap col-gap-2 card-container mt-5">
            ...
            <div class="col-lg-3 d-flex justify-content-center">
                <div class="d-flex flex-column align-items-center custom-card" style="width: 250px;">
                    <div class="col-md-3 d-flex justify-content-center">
                        <img class="icon-2" src="{{ asset('asset/img/student.png') }}">
                    </div>
                    <p class="mb-0 mt-3">Name - Ms. Thiri Shwe Sin</p>
                    <p class="mb-0 mt-3">Std ID - MST-TSS00123</p>
                    <p class="mb-0 mt-3">Batch No. - Batch - 47</p>
                </div>
            </div>
            @endfor
    </div>
