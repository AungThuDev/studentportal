...
Route::get('/{name}/user-dashboard/{id}/student/detail/{stdId}',[App\Http\Controllers\StudentController::class,'show'])->name('student.detail')->middleware(['auth','useraccess']);
